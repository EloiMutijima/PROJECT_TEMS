...
<body>
    ...
    <main>
        ...
        <div class="card">
            <h3 style="text-align: center;">CREATE STUDENT PROFILE</h3>
            <center>
        ...
        <td>
            <input type="text" placeholder="Enter your Reg No" class="input" name="regNo"><br><br>
        </td>
        </tr>
        <tr>
            <td>
    ...
    <tr>
        <td>
            ...
            <select class="input" name="level">
                <option>L6 Year 1</option>
                <option>L6 Year 2</option>
                <option>L7 Year 3</option>
            </select><br><br>
        </td>
        </table>
        </div>
        ...
        <td>
            <input type="date" placeholder="Enter the last name" class="input" name="dateOfBirth"><br><br>
        </td>
    </tr>
    <tr>
        </table>
